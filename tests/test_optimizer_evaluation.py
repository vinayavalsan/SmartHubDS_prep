    ...
    frame = pd.DataFrame(
        {
            ...
            "expected_revenue": [100.0, 100.0, 100.0],
            "bid": [10.0, 20.0, 30.0],
            "recommended_bid": [11.0, 18.0, 30.0],
            "won_flag": [1, 0, 1],
...
def test_optimizer_summary_mlflow_metrics_are_prefixed():
    summary = oe.OptimizerSummary(
        ...
        current_bid_total_expected_revenue=15.0,
        current_bid_total_expected_bid_cost=5.0,
        current_bid_total_expected_profit=10.0,
        current_bid_expected_cm=10.0 / 15.0,
        recommended_bid_total_expected_revenue=18.0,
        recommended_bid_total_expected_bid_cost=6.0,
        recommended_bid_total_expected_profit=12.0,
        recommended_bid_expected_cm=12.0 / 18.0,
